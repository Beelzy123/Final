...
- Nhận xét: Mô hình gần như không phát hiện được đối tượng (mAP = 0). Hiệu quả thấp có thể do đặc trưng đơn giản, mất cân bằng mẫu và các cảnh báo trích xuất đặc trưng/NumPy; cần mô hình mạnh hơn (ví dụ backbone học sâu) hoặc cải thiện bước tạo nhãn huấn luyện.
